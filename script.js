...
if (typeof config !== 'undefined' && config.GEMINI_API_KEY) {
  ...
  console.warn('⚠️ config.js not found or missing GEMINI_API_KEY. Please create config.js with your key.');
  ...
  if (!GEMINI_API_KEY || GEMINI_API_KEY === 'YOUR_GEMINI_API_KEY') {
    ...
    resultSection.innerHTML = `
      <div class="err-banner">
        ...
        Create <strong>config.js</strong> in the same folder with:<br>
        <code>const config = { GEMINI_API_KEY: 'your-api-key-here' };</code>
      </div>`;
    return;
  }
